...
const themes: Record<string, ThemeConfig> = {
  ...
  "Sherlock Holmes": {
    ...
    introduction: "Arthur Conan Doyle's Sherlock Holmes stories established the foundation of modern detective fiction. Through exploring these masterful mysteries, we develop analytical thinking, deductive reasoning, and sophisticated writing skills while discovering how Victorian London provides the perfect backdrop for compelling detective narratives.",
    topics: {
      "deduction": {
        quote: {
          text: "You see, but you do not observe. The distinction is clear.",
          source: "Arthur Conan Doyle, A Scandal in Bohemia",
          context: "Holmes explains to Watson the difference between passive seeing and active observation."
        },
        endings: {
          "logical_resolution": {
            description: "The mystery is solved through systematic deduction and logical reasoning, with all clues leading to an inevitable conclusion.",
            implications: [
              "Demonstrates the power of rational thinking",
              "Shows how careful observation leads to truth",
              "Reinforces the importance of evidence-based conclusions"
            ],
            questions: [
              "How does the logical resolution satisfy the reader's need for closure?",
              "What role does systematic thinking play in reaching the solution?",
              "How do all the clues work together to support the final revelation?",
              "What does this ending suggest about the nature of truth and justice?"
            ]
          },
          "unexpected_revelation": {
            description: "The solution surprises readers while remaining logically sound, revealing hidden connections and motivations.",
            implications: [
              "Challenges assumptions and preconceptions",
              "Demonstrates the complexity of human motivation",
              "Shows how surface appearances can be deceiving"
            ],
            questions: [
              "How does the surprise element enhance the story's impact?",
              "What clues were hidden in plain sight throughout the narrative?",
              "How does the revelation change our understanding of earlier events?",
              "What does this ending reveal about the nature of perception and truth?"
            ]
          },
          "moral_complexity": {
            description: "The solution reveals moral ambiguity where the 'criminal' may be sympathetic or justice is not straightforward.",
            implications: [
              "Explores the complexity of human motivation",
              "Questions simple notions of right and wrong",
              "Examines the relationship between law and justice"
            ],
            questions: [
              "How does moral complexity make the story more realistic?",
              "What factors might make a 'criminal' sympathetic to readers?",
              "How does this ending challenge our expectations of detective fiction?",
              "What does this suggest about the nature of justice and morality?"
            ]
          }
        }
      }
