...
import { MessageSquare, Eye, Users, Clock, Play, Pause, ArrowRight, CheckCircle, BookOpen, Brain, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-4 space-y-6">
            ...
            {/* Hook */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Why This Matters</h3>
              <p className="text-indigo-800 mb-4">
                Every day you craft sentences in texts, social media, and conversations that shape how others see the world. Just like the authors of 1984 or The Hunger Games, you have the power to create atmosphere and influence emotions through your words. Today, you'll master the building blocks that make writing compelling—complete sentences that grab attention and don't let go. These aren't just grammar rules; they're tools for making your voice heard and your ideas unforgettable in a world full of competing messages.
              </p>
            </div>
