                          ...
                          {lessonData.observation_prompts.map((prompt, index) => (
                            <div key={index} className="flex items-start justify-between p-3 bg-white rounded-lg border border-purple-200">
                              <div className="flex items-start gap-2 flex-1">
                                ...
                                <EnhancedMiniAssistant answer={
                                  prompt.includes('sentence construction to writing confidence') 
                                    ? "Look for comments like 'I feel more confident writing now' or 'I understand how to make my sentences clearer.' Notice when students connect technical skills to their overall writing ability."
                                    : prompt.includes('sentence techniques students find most valuable')
                                    ? "Listen for students saying things like 'Complex sentences help me show relationships between ideas' or 'Simple sentences create more impact.' Watch for students explaining which techniques they'll use again."
                                    : prompt.includes('deeper understanding about sentence effectiveness')
                                    ? "Notice when students move beyond just identifying techniques to explaining WHY they work. Look for comments about reader impact, atmosphere creation, or how sentence choice affects meaning."
                                    : prompt.includes('build on each other\'s insights about atmospheric writing')
                                    ? "Watch for students adding to each other's ideas: 'Building on what Sarah said about short sentences...' or 'That reminds me of how we used...' Notice collaborative knowledge building."
                                    : "Focus on how students engage with ideas, build on each other's thoughts, and develop understanding through dialogue."
                                } />
                              </div>
