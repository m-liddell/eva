...
function QuickAssessView({ lesson, onBack }: QuickAssessViewProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Save assessment to localStorage for demo
        ...
        <div className="bg-white rounded-lg border border-[#A4AAB2] p-3 sticky top-4 z-20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <h1 className="text-base sm:text-lg font-bold text-[#768396]">Marking</h1>
                <button 
              ...
              <div className="space-y-2">
                {upcomingLessons.slice(0, 3).map((lesson, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="font-medium text-xs sm:text-sm">{lesson.subject}</div>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-900 text-sm sm:text-base">Quick Assess</h4>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-600 pl-10">
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-900 text-sm sm:text-base">Student Self-Assess</h4>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-600 pl-10">
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-900 text-sm sm:text-base">Detailed Assessment</h4>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-600 pl-10">
