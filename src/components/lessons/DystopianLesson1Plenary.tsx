        ...
        <div className="mb-8 p-6 bg-white/95 backdrop-blur-sm rounded-xl border border-gray-200 shadow-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => router.push('/lesson/dystopian-lesson-1/starter')}
              ...
              <button
                onClick={() => router.push('/lesson/dystopian-lesson-1/main')}
        ...
        >
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-center pt-6 border-t border-gray-200">
              <NavigationArrow
                direction="left"
               onClick={() => router.push(lessonData.previousRoute)}
                label="Back to Main"
              />
              <NavigationArrow
                direction="right"
               onClick={() => router.push(lessonData.nextRoute)}
                label="Next Lesson"
              />
            </div>
          </div>
