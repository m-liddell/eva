...
const WelcomeHeader: React.FC<{
  ...
  <div className="flex items-center justify-between mb-6">
    <div>
      <h1 className="text-2xl font-bold text-[#768396] mb-1">Welcome back, {userName}</h1>
...
function Home() {
  ...
  useEffect(() => {
    try {
      ...
      if (pocUser) {
        ...
        setUserName(parsedUserData?.name || 'Teacher');
        return;
      }
  ...
  const handleLessonClick = (lesson: Lesson) => {
    if (isLessonFullyPlanned(lesson)) {
      // Always route to dystopian lesson 2 for the Teach module
      router.push('/lesson/dystopian-lesson-2/starter');
    } else {
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-4 sm:py-6">
      <WelcomeHeader userName={userName} userData={userData} />
      
      {/* Help Button */}
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40">
        <button
          onClick={resetOnboarding}
          className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FFC83D] text-white rounded-full shadow-lg hover:bg-[#E6B434] transition-colors flex items-center justify-center"
      ...
      <div id="plan-section" className="bg-white rounded-lg shadow-sm border border-[#A4AAB2] p-4 mb-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg sm:text-xl font-bold">Plan</h2>
          </div>
        </div>
      ...
      <div id="teach-section" className="bg-white rounded-lg shadow-sm border border-[#A4AAB2] p-4 mb-4">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-lg sm:text-xl font-bold">Teach</h2>
        </div>
