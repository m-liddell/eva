...
function TermSchedule() {
  ...
  return (
    <div className="min-h-[calc(100vh-48px)] bg-[#F8F9FA]">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-2 w-full">
        ...
        {weekLessons.length === 0 && currentStep === PLANNING_STEPS.ADD_LESSONS ? (
          <div className="bg-white rounded-lg border border-[#A4AAB2] p-12 text-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">No lessons yet</h3>
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2 sm:py-3 bg-[#FFC83D] text-white rounded-lg hover:bg-[#E6B535] transition-colors flex items-center gap-2 mx-auto text-sm sm:text-base"
            >
              <Plus className="w-5 h-5" />
              Add Lessons
            </button>
            ...
            <div className="p-4 border-b border-gray-200 bg-gray-50">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-base sm:text-lg font-semibold text-gray-800">{TERMS[currentTerm].name}</h2>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {!stepCompletion.isStepCompleted(currentTerm, 1) && (
                    <button
                      onClick={() => setIsAddingLesson(true)}
                      className="px-3 sm:px-4 py-2 bg-[#FFC83D] text-white rounded-lg hover:bg-[#E6B535] transition-colors flex items-center gap-2 text-sm"
                    >
                      <Plus className="w-4 h-4" />
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="px-2 sm:px-3 py-1 bg-[#FFC83D]/10 text-[#FFC83D] rounded-lg font-medium text-xs sm:text-sm">
                      Week {currentWeek}
                    </div>
                    <button
                  ...
                  {selectedLessonsList.length > 0 && (
                    <div className="flex items-center gap-2">
                      <span className="text-xs sm:text-sm text-gray-600">{selectedLessonsList.length} selected</span>
                      <button
          ...
          <div className="bg-white rounded-lg border border-[#A4AAB2] p-6 sm:p-12 text-center">
            <div className="w-16 h-16 bg-[#FFF9E7] rounded-full flex items-center justify-center mx-auto mb-4">
              <Calendar className="w-8 h-8 text-[#FFC83D]" />
            </div>
            <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">No lessons for Week {currentWeek}</h3>
            <p className="text-gray-600 mb-6">
