...
export function VerticalTimetable({ term, termId, onEditLesson, currentWeek = 1 }: VerticalTimetableProps) {
              ...
              <div className="flex items-center justify-between gap-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      // Store lesson data in sessionStorage for Next.js
                      sessionStorage.setItem('preselectedLesson', JSON.stringify(lesson));
  ...
  return (
    <div className="relative">
      <div className="overflow-x-auto max-h-[calc(100vh-200px)] sm:max-h-[calc(100vh-300px)]">
        <div className="min-w-[900px]">
          {showSelectionInfo && (
            <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-30 bg-white rounded-lg shadow-lg border border-gray-200 p-4 w-80 sm:w-96 mx-4">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="w-8 sm:w-12 p-1 border-b border-gray-200 bg-gray-50 text-xs"></th>
                {DAYS.map(day => (
                  <th 
                    key={day}
                    className="min-w-[120px] sm:min-w-[160px] w-1/5 p-1 text-center border-b border-gray-200 bg-gray-50 font-medium text-gray-700 text-xs"
                  >
