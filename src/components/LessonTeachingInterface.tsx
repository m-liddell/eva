  ...
  useEffect(() => {
    if (lesson.theme === 'Dystopian Fiction') {
      ...
      if (lesson.week >= 1 && lesson.week <= 6) {
        sessionStorage.setItem('currentLesson', JSON.stringify(lesson));
        router.replace(`/lesson/dystopian-lesson-${lesson.week}/${startingPhase}`);
        return;
      }
    }
  }, [lesson, router]);
